  ...
  return (
    <>
                    ...
                    searchFilteredProduct.map((product) => {
                      return (
                        <li key={product.id} onClick={openSearchInput}>
                          ...
                          >
                            <span className="rounded flex justify-center items-center overflow-hidden bg-[#555] w-14 h-16">
                              <img
                                className="h-full"
                                width="100%"
                                height="100%"
      ...
      <Drawer
        ...
        className={`p-4 side-bar-links flex flex-col transition-all z-[9998] !max-w-full md:!max-w-xs ${
      ...
      <Dialog
        open={open}
        size="xs"
        className="p-2 py-0 m-0 md:h-max z-[999999] !w-screen overflow-auto h-full min-w-full"
        handler={handleOpen}
      >
